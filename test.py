...
#                 cv2.waitKey(0)
#                 cv2.imwrite('./result/1.jpg', img_clone)
#
...
def parse_args():
    ...
    parser.add_argument('--backbone', default='lite', type=str, choices=["v2", "v3", "lite", "ghost"])
    parser.add_argument('--model_path', default='./checkpoint/lite.pth', type=str)
